    ...
    out = `
      <div class="tf-box">
        ...
        <div class="tf-btns">
          ...
          <button class="mini" data-act="share">分享…</button>
        </div>
        <div class="r-meta" data-linkbox>链接：${tfEsc2(tfLinkFor(u.out))}</div>
        <div class="tf-btns"><button class="mini" data-act="copylink">复制链接</button></div>
      </div>`;
  }
  /* ---------- 导入预览 ---------- */
  let prev = '';
  ...
  el.innerHTML = `
    <div class="tf-wrap">
      ...
      <section class="tf-sec">
        ...
        ${u.out ? out : `
          <div class="tf-row">
            <input class="tf-pin" data-pin="1" type="password" inputmode="numeric" maxlength="4" value="${tfEsc2(u.pin)}" placeholder="设 4 位密码">
            <input class="tf-pin" data-pin="2" type="password" inputmode="numeric" maxlength="4" value="${tfEsc2(u.pin2)}" placeholder="再输一次">
          </div>
      ...
      <section class="tf-sec">
        ...
        ${u.phase === 'preview' ? '' : `
          ...
          <div class="tf-row">
            <input class="tf-pin" data-pin="3" type="password" inputmode="numeric" maxlength="4" value="${tfEsc2(u.impPin)}" placeholder="4 位密码">
